using Dapper;
using SV22T1020283.DataLayers.Interfaces;
using SV22T1020283.Models.Common;
using SV22T1020283.Models.Partner;
using SV22T1020283.Models.Shop;

namespace SV22T1020283.DataLayers.SQLServer
{
    public class CustomerRepository : BaseRepository, ICustomerRepository
    {
        ...
        // SV22T1020283.DataLayers.SQLServer/CustomerRepository.cs
        ...
        public async Task<bool> UpdateAsync(Customer data)
        {
            ...
            // ⚠️ KHÔNG cập nhật Password trong update thông thường
